...
public class GradeAdapter extends RecyclerView.Adapter<GradeAdapter.GradeHolder> {
    ...
    public GradeAdapter(Context context, ArrayList<User> students) {
    ...
    public GradeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View item = layoutInflater.inflate(R.layout.item_grade, parent, false);
        return new GradeHolder(item);
    }
    ...
    public class GradeHolder extends RecyclerView.ViewHolder {
        TextView number, name, td, tp, exam;
